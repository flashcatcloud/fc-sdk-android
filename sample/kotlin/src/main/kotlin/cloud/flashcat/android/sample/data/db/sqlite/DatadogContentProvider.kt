...
package cloud.flashcat.android.sample.data.db.sqlite
...
import cloud.flashcat.android.sample.data.db.DatadogDbContract
import cloud.flashcat.android.trace.sqlite.transactionTraced
...
internal class DatadogContentProvider : ContentProvider() {
    ...
    companion object {
        private const val CONTENT_PROVIDER_AUTHORITY = "cloud.flashcat.android.provider"
