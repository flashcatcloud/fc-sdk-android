...
package cloud.flashcat.android.sample.viewpager
...
internal open class PagerChildFragment : Fragment() {
    ...
    companion object {
        internal const val ARG_PAGE_NAME: String = "cloud.flashcat.android.sample.viewpager.PagerChildFragment.PAGE_NAME"

        internal const val ARG_WEB_VIEW_URL: String =
            "cloud.flashcat.android.sample.viewpager.PagerChildFragment.WEB_VIEW_URL"
    }
}
