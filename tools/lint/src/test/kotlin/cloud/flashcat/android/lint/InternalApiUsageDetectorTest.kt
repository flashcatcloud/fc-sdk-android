...
package cloud.flashcat.android.lint
...
internal class InternalApiUsageDetectorTest {
    ...
    fun `M report issue W internal class is used from non-Datadog package { java }`() {
        lint()
            .files(
                ...
                import cloud.flashcat.android.InternalSdkClass;
            ...
            .expect(
                """
                    src/${nonDatadogPackage.packageToPath()}/ClassUnderTest.java:8: Error: Symbols annotated with cloud.flashcat.android.lint.InternalApi shouldn't be used outside of FlashCat SDK packages. [DatadogInternalApiUsage]
                           InternalSdkClass instance = new InternalSdkClass();
                                                       ~~~~~~~~~~~~~~~~~~~~~~
                    1 errors, 0 warnings
                """
    ...
    fun `M report issue W internal method is used from non-Datadog package { java }`() {
        lint()
            .files(
                ...
                import cloud.flashcat.android.SomeSdkClass;
            ...
            .expect(
                """
                    src/${nonDatadogPackage.packageToPath()}/ClassUnderTest.java:9: Error: Symbols annotated with cloud.flashcat.android.lint.InternalApi shouldn't be used outside of FlashCat SDK packages. [DatadogInternalApiUsage]
                           instance.internalMethod();
                           ~~~~~~~~~~~~~~~~~~~~~~~~~
                    1 errors, 0 warnings
                """
    ...
    fun `M report issue W method of internal interface is used from non-Datadog package { java }`() {
        lint()
            .files(
                ...
                import cloud.flashcat.android.SdkCore;
    ...
    fun `M report issue W internal extension method is used from non-Datadog package { java }`() {
        lint()
            .files(
                ...
                import cloud.flashcat.android.TestKt;
    ...
    fun `M report issue W internal class is used from non-Datadog package { kotlin }`() {
        lint()
            ...
            .expect(
                """
                   src/${nonDatadogPackage.packageToPath()}/ClassUnderTest.kt:8: Error: Symbols annotated with cloud.flashcat.android.lint.InternalApi shouldn't be used outside of FlashCat SDK packages. [DatadogInternalApiUsage]
                          val instance = InternalSdkClass()
                                         ~~~~~~~~~~~~~~~~~~
                   1 errors, 0 warnings
                """
    ...
    fun `M report issue W internal method is used from non-Datadog package { kotlin }`() {
        lint()
            ...
            .expect(
                """
                   src/${nonDatadogPackage.packageToPath()}/ClassUnderTest.kt:9: Error: Symbols annotated with cloud.flashcat.android.lint.InternalApi shouldn't be used outside of FlashCat SDK packages. [DatadogInternalApiUsage]
                          instance.internalMethod()
                          ~~~~~~~~~~~~~~~~~~~~~~~~~
                   1 errors, 0 warnings
                """
    ...
    fun `M report issue W internal extension method is used from non-Datadog package { kotlin }`() {
        lint()
            .files(
                ...
                import cloud.flashcat.android.internalMethod
            ...
            .expect(
                """
                   src/${nonDatadogPackage.packageToPath()}/ClassUnderTest.kt:13: Error: Symbols annotated with cloud.flashcat.android.lint.InternalApi shouldn't be used outside of FlashCat SDK packages. [DatadogInternalApiUsage]
                          literal.internalMethod()
                          ~~~~~~~~~~~~~~~~~~~~~~~~
                   1 errors, 0 warnings
                """
