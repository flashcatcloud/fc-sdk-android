...
class InternalApiUsageDetector : Detector(), SourceCodeScanner {
    ...
    override fun applicableAnnotations() = listOf("cloud.flashcat.android.lint.InternalApi")
    ...
    override fun visitAnnotationUsage(
        ...
        if (!packageName.isNullOrEmpty() && !packageName.startsWith("cloud.flashcat")) {
            context.report(
                issue = ISSUE,
                scope = element,
                location = context.getLocation(usageInfo.usage),
                message = "Symbols annotated with `cloud.flashcat.android.lint.InternalApi` shouldn't" +
    ...
    internal companion object {
        ...
        val ISSUE = Issue.create(
            ...
            explanation = "Usages of classes and methods annotated" +
                " with `cloud.flashcat.android.lint.InternalApi` are prohibited",
