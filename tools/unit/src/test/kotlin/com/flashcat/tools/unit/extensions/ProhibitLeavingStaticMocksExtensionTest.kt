...
package com.flashcat.tools.unit.extensions
...
class ProhibitLeavingStaticMocksExtensionTest {
    ...
    fun `M exception thrown has valid message W mock in nested object`() {
        ...
        assertThat(exception.message)
            .isEqualTo(
                "Unexpected mock remaining in the field badMock of com.flashcat.tools.unit." +
                    "extensions.ProhibitLeavingStaticMocksExtensionTest\$MockInObjectClass.\n" +
                    "Calling sequence:\ncom.flashcat.tools.unit.extensions." +
    ...
    companion object {
        val PACKAGE_PREFIXES = listOf("com.flashcat")
    }
