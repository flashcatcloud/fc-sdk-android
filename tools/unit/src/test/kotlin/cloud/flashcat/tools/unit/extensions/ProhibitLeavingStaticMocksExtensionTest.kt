...
package cloud.flashcat.tools.unit.extensions
...
class ProhibitLeavingStaticMocksExtensionTest {
    ...
    fun `M exception thrown has valid message W mock in nested object`() {
        ...
        assertThat(exception.message)
            .isEqualTo(
                "Unexpected mock remaining in the field badMock of cloud.flashcat.tools.unit." +
                    "extensions.ProhibitLeavingStaticMocksExtensionTest\$MockInObjectClass.\n" +
                    "Calling sequence:\ncloud.flashcat.tools.unit.extensions." +
    ...
    companion object {
        val PACKAGE_PREFIXES = listOf("cloud.flashcat")
    }
