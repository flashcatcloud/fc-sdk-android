...
package cloud.flashcat.tools.detekt.rules.sdk

import cloud.flashcat.tools.detekt.rules.AbstractTypedRule
 ...
 * `cloud.flashcat.android.*.internal.*` package name.
 * @active
 */
...
class PackageNameVisibility(
    ...
    companion object {
         ...
         */
        private const val ESCAPE_PACKAGE = "cloud.flashcat.android.internal"
    }
}
