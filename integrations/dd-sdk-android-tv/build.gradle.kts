...
android {
    namespace = "cloud.flashcat.android.tv"
}
...
publishingConfig(
    "An Android TV integration to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-tv"
)
detektCustomConfig()
