...
android {
    namespace = "cloud.flashcat.android.fresco"
}
...
publishingConfig(
    "A Fresco integration to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-fresco"
)
detektCustomConfig()
