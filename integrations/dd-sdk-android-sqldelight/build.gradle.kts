...
android {
    namespace = "cloud.flashcat.android.sqldelight"
}
...
publishingConfig(
    "A SQLDelight integration to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-sqldelight"
)
detektCustomConfig()
