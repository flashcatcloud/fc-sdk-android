...
android {
    namespace = "cloud.flashcat.android.rum.coroutines"
}
...
publishingConfig(
    "A RUM Coroutines extension library to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-rum-coroutines"
)
detektCustomConfig()
