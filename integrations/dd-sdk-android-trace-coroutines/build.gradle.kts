...
android {
    namespace = "cloud.flashcat.android.trace.coroutines"
}
...
publishingConfig(
    "A Trace Coroutines extension library to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-trace-coroutines"
)
detektCustomConfig()
