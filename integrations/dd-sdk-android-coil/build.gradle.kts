...
android {
    namespace = "cloud.flashcat.android.coil"
}
...
publishingConfig(
    "A Coil integration to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-coil"
)
detektCustomConfig()
