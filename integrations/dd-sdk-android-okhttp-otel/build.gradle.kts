...
android {
    namespace = "cloud.flashcat.android.okhttp.otel"
}
...
publishingConfig(
    "An OkHttp collection of extensions to be used in conjunction with OpenTelemetry FlashCat SDK.",
    customArtifactId = "fc-sdk-android-okhttp-otel"
)
detektCustomConfig()
