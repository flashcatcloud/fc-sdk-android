...
android {
    namespace = "cloud.flashcat.android.timber"
}
...
publishingConfig(
    "A Timber integration to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-timber"
)
detektCustomConfig()
