...
android {
    namespace = "cloud.flashcat.android.okhttp"
}
...
publishingConfig(
    "An OkHttp monitoring integration to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-okhttp"
)
detektCustomConfig()
