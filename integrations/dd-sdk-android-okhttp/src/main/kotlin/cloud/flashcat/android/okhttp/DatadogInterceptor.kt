...
import cloud.flashcat.android.internal.network.GraphQLHeaders
import cloud.flashcat.android.okhttp.internal.rum.NoOpRumResourceAttributesProvider
import cloud.flashcat.android.okhttp.internal.rum.buildResourceId
...
open class DatadogInterceptor internal constructor(
     ...
     * be automatically tracked by this interceptor. If registering a [cloud.flashcat.android.trace.GlobalDatadogTracer],
     * the tracer must be configured with [cloud.flashcat.android.trace.api.tracer.DatadogTracerBuilder.withTracingHeadersTypes] containing all the necessary
