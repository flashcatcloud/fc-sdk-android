...
import cloud.flashcat.android.core.SdkReference
import cloud.flashcat.android.core.configuration.Configuration
import cloud.flashcat.android.core.configuration.HostsSanitizer
...
import cloud.flashcat.android.trace.api.DatadogTracingConstants.Tags
 ...
 * [cloud.flashcat.android.okhttp.DatadogInterceptor] instead, which combines the RUM and APM integrations.
 *
...
internal constructor(
     ...
     * configured with [cloud.flashcat.android.trace.api.tracer.DatadogTracerBuilder.withTracingHeadersTypes] containing all the necessary
