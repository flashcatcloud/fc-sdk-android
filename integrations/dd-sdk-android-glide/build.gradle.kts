...
android {
    namespace = "cloud.flashcat.android.glide"
}
...
publishingConfig(
    "A Glide integration to use with the FlashCat monitoring library for Android applications.",
    customArtifactId = "fc-sdk-android-glide"
)
detektCustomConfig()
