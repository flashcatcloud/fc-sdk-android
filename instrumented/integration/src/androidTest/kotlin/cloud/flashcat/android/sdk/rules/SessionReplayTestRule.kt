...
import cloud.flashcat.android.sdk.integration.sessionreplay.overrideProcessImportance
import cloud.flashcat.android.sdk.utils.addExtras
...
internal open class SessionReplayTestRule<T : Activity>(
    ...
    companion object {
        private const val SESSION_REPLAY_LIFECYCLE_CALLBACK_CLASS_NAME =
            "cloud.flashcat.android.sessionreplay.internal.SessionReplayLifecycleCallback"
    }
}
