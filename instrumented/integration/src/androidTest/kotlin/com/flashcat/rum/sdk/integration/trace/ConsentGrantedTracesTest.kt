...
internal class ConsentGrantedTracesTest : TracesTest() {
    ...
    fun verifyExpectedActivitySpansAndLogs() {
        ...
        ConditionWatcher {
            ...
            val flashcatContext = mockServerRule.activity.getFlashcatContext()!!
            verifyExpectedSpans(flashcatContext, handledRequests, mockServerRule.activity.getSentSpans())
