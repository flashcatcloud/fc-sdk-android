...
import com.flashcat.rum.sdk.assertj.HeadersAssert
import com.flashcat.rum.sdk.assertj.HeadersAssert.Companion.assertThat
...
import com.flashcat.rum.sdk.utils.isLogsUrl
import com.flashcat.rum.sdk.utils.isTracesUrl
import com.flashcat.rum.trace.api.resolveMeta
...
internal abstract class TracesTest {
    ...
    private fun assertMatches(jsonObject: JsonObject, span: DatadogSpan, context: FlashcatContext) {
