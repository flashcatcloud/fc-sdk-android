...
import com.flashcat.rum.core.internal.flashcatContextProvider
...
import com.flashcat.rum.utils.forge.CustomAttributes
...
/**
 * This region groups all test about instantiating a FlashcatCore instance.
...
internal class FlashcatCoreInitializationTest {

    lateinit var testedCore: FlashcatCore
    ...
    fun `M initialize requested features W initialize()`(
        ...
        assertThat(testedCore.contextProvider).isInstanceOf(flashcatContextProvider::class.java)
    ...
    fun `M throw an error W initialize() {envName not valid, isDebug=false}`(
        ...
        assertThat(exception)
            .hasMessage(FlashcatCore.MESSAGE_ENV_NAME_NOT_VALID)
    }
