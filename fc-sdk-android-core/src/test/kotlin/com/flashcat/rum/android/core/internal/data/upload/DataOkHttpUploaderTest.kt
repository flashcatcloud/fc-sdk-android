...
import com.flashcat.rum.internal.profiler.ExecutionTimer
...
import com.flashcat.rum.api.net.Request as DatadogRequest
...
internal class DataOkHttpUploaderTest {
    ...
    @Forgery
    lateinit var fakeContext: FlashcatContext
    ...
    fun `set up`(forge: Forge) {
        ...
        fakeSdkUserAgent = "Flashcat/$fakeSdkVersion " +
