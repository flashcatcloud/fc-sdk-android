...
package com.flashcat.rum.core.internal.metrics
...
import com.flashcat.rum.core.internal.metrics.MethodCalledTelemetry.Companion.CALLER_CLASS
import com.flashcat.rum.core.internal.metrics.MethodCalledTelemetry.Companion.EXECUTION_TIME
import com.flashcat.rum.core.internal.metrics.MethodCalledTelemetry.Companion.IS_SUCCESSFUL
import com.flashcat.rum.core.internal.metrics.MethodCalledTelemetry.Companion.METHOD_CALLED_METRIC_NAME
...
internal class MethodCalledTelemetryTest {
    ...
    fun setup(forge: Forge) {
        ...
        whenever(mockInternalSdkCore.getFlashcatContext()).thenReturn(mockflashcatContext)
        whenever(mockflashcatContext.deviceInfo).thenReturn(mockDeviceInfo)
