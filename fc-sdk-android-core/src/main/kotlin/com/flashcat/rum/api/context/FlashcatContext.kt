...
package com.flashcat.rum.api.context
 ...
 * @property site [Flashcat Site](https://docs.flashcat.cloud/getting_started/site/) for data uploads.
 * @property clientToken the client token allowing for data uploads to
 * [Flashcat Site](https://docs.flashcat.cloud/getting_started/site/).
 * @property service the name of the service that data is generated from. Used for
 * [Unified Service Tagging](https://docs.flashcat.cloud/getting_started/tagging/unified_service_tagging).
 ...
 * data is generated from. See: Datadog [Reserved Attributes](https://docs.flashcat.cloud/logs/log_configuration/attributes_naming_convention/#reserved-attributes).
