...
import com.flashcat.rum.Flashcat.clearAccountInfo
...
/**
 * This class initializes the Flashcat SDK, and sets up communication with the server.
 */
...
object Flashcat {
    ...
    /**
     * Sets the verbosity of this instance of the Flashcat SDK.
     *
    ...
    /**
     * Gets the verbosity of this instance of the Flashcat SDK.
     *
     * Messages with a priority level equal or above the given level will be sent to Android's
     * Logcat.
     *
    ...
    /**
     * Sets the tracking consent regarding the data collection for this instance of the Flashcat SDK.
     *
    ...
    private fun flushAndShutdownExecutors() {
        ...
        synchronized(registry) {
            ...
            if (sdkCore != null) {
                ...
                (sdkCore as? FlashcatCore)?.flushStoredData()
            }
        }
    }
    ...
    internal const val MESSAGE_ALREADY_INITIALIZED =
        "The Flashcat library has already been initialized."
