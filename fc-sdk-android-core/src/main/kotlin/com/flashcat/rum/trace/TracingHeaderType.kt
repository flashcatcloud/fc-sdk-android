...
enum class TracingHeaderType(val headerType: String) {
    /**
     * Datadog's [`x-datadog-*` header](https://docs.flashcat.cloud/real_user_monitoring/connect_rum_and_traces/?tab=browserrum#how-are-rum-resources-linked-to-traces).
     */
    DATADOG("DATADOG"),
