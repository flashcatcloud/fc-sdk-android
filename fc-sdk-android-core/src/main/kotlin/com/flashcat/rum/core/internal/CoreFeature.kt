...
import com.flashcat.rum.core.internal.account.DatadogAccountInfoProvider
import com.flashcat.rum.core.internal.account.MutableAccountInfoProvider
import com.flashcat.rum.core.internal.account.NoOpMutableAccountInfoProvider
import com.flashcat.rum.core.internal.data.upload.CurlInterceptor
import com.flashcat.rum.core.internal.data.upload.GzipRequestInterceptor
import com.flashcat.rum.core.internal.data.upload.RotatingDnsResolver
import com.flashcat.rum.core.internal.net.DefaultFirstPartyHostHeaderTypeResolver
import com.flashcat.rum.core.internal.net.info.BroadcastReceiverNetworkInfoProvider
import com.flashcat.rum.core.internal.net.info.CallbackNetworkInfoProvider
import com.flashcat.rum.core.internal.net.info.NetworkInfoProvider
import com.flashcat.rum.core.internal.net.info.NoOpNetworkInfoProvider
import com.flashcat.rum.core.internal.persistence.JsonObjectDeserializer
...
import com.flashcat.rum.core.internal.persistence.file.batch.BatchFileReaderWriter
import com.flashcat.rum.core.internal.persistence.file.deleteSafe
import com.flashcat.rum.core.internal.persistence.file.existsSafe
import com.flashcat.rum.core.internal.persistence.file.readTextSafe
import com.flashcat.rum.core.internal.persistence.file.writeTextSafe
import com.flashcat.rum.core.internal.privacy.ConsentProvider
import com.flashcat.rum.core.internal.privacy.NoOpConsentProvider
import com.flashcat.rum.core.internal.privacy.TrackingConsentProvider
import com.flashcat.rum.core.internal.system.AndroidInfoProvider
import com.flashcat.rum.core.internal.system.AppVersionProvider
import com.flashcat.rum.core.internal.system.BroadcastReceiverSystemInfoProvider
import com.flashcat.rum.core.internal.system.DefaultAndroidInfoProvider
import com.flashcat.rum.core.internal.system.DefaultAppVersionProvider
import com.flashcat.rum.core.internal.system.NoOpAndroidInfoProvider
import com.flashcat.rum.core.internal.system.NoOpAppVersionProvider
import com.flashcat.rum.core.internal.system.NoOpSystemInfoProvider
import com.flashcat.rum.core.internal.system.SystemInfoProvider
import com.flashcat.rum.core.internal.thread.BackPressureExecutorService
import com.flashcat.rum.core.internal.thread.BackPressuredBlockingQueue
import com.flashcat.rum.core.internal.thread.DatadogThreadFactory
import com.flashcat.rum.core.internal.thread.LoggingScheduledThreadPoolExecutor
import com.flashcat.rum.core.internal.thread.ScheduledExecutorServiceFactory
import com.flashcat.rum.core.internal.time.AppStartTimeProvider
import com.flashcat.rum.core.internal.time.DatadogNtpEndpoint
import com.flashcat.rum.core.internal.time.KronosTimeProvider
import com.flashcat.rum.core.internal.time.LoggingSyncListener
import com.flashcat.rum.core.internal.user.DatadogUserInfoProvider
import com.flashcat.rum.core.internal.user.MutableUserInfoProvider
import com.flashcat.rum.core.internal.user.NoOpMutableUserInfoProvider
...
import com.flashcat.rum.internal.utils.allowThreadDiskReads
import com.flashcat.rum.ndk.internal.DatadogNdkCrashHandler
import com.flashcat.rum.ndk.internal.NdkCrashHandler
import com.flashcat.rum.ndk.internal.NdkCrashLogDeserializer
import com.flashcat.rum.ndk.internal.NoOpNdkCrashHandler
...
internal class CoreFeature(
    ...
    @Volatile
    internal var site: FlashcatSite = FlashcatSite.US1
    ...
    companion object {
        internal const val SDK_INITIALIZED_IN_SECONDARY_PROCESS_WARNING_MESSAGE =
            "Flashcat SDK was initialized in a secondary process: although data will still be captured," +
