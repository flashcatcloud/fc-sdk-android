...
import com.flashcat.rum.core.internal.lifecycle.ProcessLifecycleCallback
import com.flashcat.rum.core.internal.lifecycle.ProcessLifecycleMonitor
import com.flashcat.rum.core.internal.logger.SdkInternalLogger
...
import com.flashcat.rum.core.internal.time.DefaultAppStartTimeProvider
...
import com.flashcat.rum.error.internal.CrashReportsFeature
...
internal class FlashcatCore(
    ...
    override fun setTrackingConsent(consent: TrackingConsent) {
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.setTrackingConsent", internalLogger) {
    ...
    override fun setUserInfo(
        ...
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.setUserInfo", internalLogger) {
    ...
    override fun addUserProperties(extraInfo: Map<String, Any?>) {
        val extraInfoSnapshot = extraInfo.toMap()
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.addUserProperties", internalLogger) {
    ...
    override fun clearUserInfo() {
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.clearUserInfo", internalLogger) {
    ...
    override fun clearAllData() {
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.clearAllData", internalLogger) {
    ...
    override fun setAccountInfo(
        ...
        val extraInfoSnapshot = extraInfo.toMap()
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.setAccountInfo", internalLogger) {
    ...
    override fun addAccountExtraInfo(
        ...
        val extraInfoSnapshot = extraInfo.toMap()
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.addAccountExtraInfo", internalLogger) {
            coreFeature.accountInfoProvider.addExtraInfo(extraInfoSnapshot)
        }
    }

    override fun clearAccountInfo() {
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.clearAccountInfo", internalLogger) {
    ...
    override fun updateFeatureContext(
        ...
        if (useContextThread) {
            coreFeature.contextExecutorService.executeSafe(
                "FlashcatCore.updateFeatureContext-$featureName",
                internalLogger,
                runnable
            )
        } else {
    ...
    override fun getFeatureContext(featureName: String, useContextThread: Boolean): Map<String, Any?> {
        ...
        return if (useContextThread) {
            return coreFeature.contextExecutorService
                .submitSafe(
                    "FlashcatCore.getFeatureContext-$featureName",
                    internalLogger,
                    callable
                )
                .getSafe("FlashcatCore.getFeatureContext-$featureName", internalLogger)
                .orEmpty()
        } else {
    ...
    override fun setAnonymousId(anonymousId: UUID?) {
        coreFeature.contextExecutorService.executeSafe("FlashcatCore.setAnonymousId", internalLogger) {
    ...
    override fun getFlashcatContext(withFeatureContexts: Set<String>): FlashcatContext? {
        return coreFeature.contextExecutorService
            ...
            .getSafe("getflashcatContext", internalLogger)
    }
    ...
    internal fun initialize(configuration: Configuration) {
        ...
        contextProvider = flashcatContextProvider(coreFeature) {
    ...
    /**
     * Stops all process for this instance of the Flashcat SDK.
     */
    internal fun stop() {
    ...
    companion object {
        ...
        internal const val MESSAGE_ENV_NAME_NOT_VALID =
            "The environment name should contain maximum 196 of the following allowed characters " +
                ...
                "In this case the Flashcat SDK will not be initialised."
