...
import com.flashcat.rum.core.internal.persistence.file.lengthSafe
...
internal class ConsentAwareStorage(
    ...
    override fun getEventWriteScope(
        ...
        val orchestrator = resolveOrchestrator(flashcatContext)
    ...
    @AnyThread
    private fun resolveOrchestrator(flashcatContext: FlashcatContext): FileOrchestrator? {
        return when (flashcatContext.trackingConsent) {
