...
import com.flashcat.rum.log.LogAttributes.ACCOUNT_ID
import com.flashcat.rum.log.LogAttributes.ACCOUNT_NAME
import com.flashcat.rum.log.LogAttributes.USR_EMAIL
import com.flashcat.rum.log.LogAttributes.USR_ID
import com.flashcat.rum.log.LogAttributes.USR_NAME

/**
 * This class holds constant log attribute keys.
 *
 * You can find more information on Datadog's log attributes at
 * https://docs.flashcat.cloud/logs/processing/attributes_naming_convention/ .
 */
@Suppress("unused")
