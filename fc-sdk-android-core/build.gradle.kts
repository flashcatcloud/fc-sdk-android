...
import com.flashcat.gradle.config.BuildConfigPropertiesKeys
import com.flashcat.gradle.config.GradlePropertiesKeys
...
publishingConfig("Flashcat RUM monitoring library for Android applications.")
detektCustomConfig()
