...
To include the FlashCat SDK for Android in your project, simply add any product you want to use to your application's `build.gradle` file.

For example, in case of RUM:

```groovy
dependencies {
    implementation "com.flashcat:fc-sdk-android-rum:<latest-version>"
}
```
...
in FlashCat. **Make sure you create a key of type `Client Token`.**
...
## Setting up FlashCat RUM SDK

See the dedicated [FlashCat Android RUM Collection documentation][1] to learn how to send RUM data from your Android or Android TV application to FlashCat.
