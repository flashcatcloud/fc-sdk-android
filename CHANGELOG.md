...
* **WARNING**: Existing `cloud.flashcat.trace` package renamed to `cloud.flashcat.legacy.trace`. `cloud.flashcat.trace` package will contain new members, so update your imports accordingly.
...
* [IMRROVEMENT] Make constructors of `FlashcatSite` private. See [#2010](https://github.com/DataDog/dd-sdk-android/pull/2010)
