...
package cloud.flashcat.android.logs.integration
...
import cloud.flashcat.android.logs.integration.tests.elmyr.LogsIntegrationForgeConfigurator
...
class LoggerTest {
    ...
    fun `M send log with exception W Logger#log()`(
        ...
        assertThat(event0.getString("error.stack"))
            .contains("\tat cloud.flashcat.tools.unit.forge.ThrowableKt.anException")
    }
