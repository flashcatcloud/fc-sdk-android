...
internal class RumViewManagerScopeTest {
    ...
    fun `M reset feature flags W handleEvent(StartView) { view already active }`(
        ...
        // When
        testedScope.handleEvent(secondViewEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M send gap message W handleEvent(StopView) + handleEvent(StartView)`(
        ...
        testedScope.applicationDisplayed = true
        testedScope.handleEvent(firstViewEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val stopFirstViewEvent = RumRawEvent.StopView(firstViewEvent.key, emptyMap())
        testedScope.handleEvent(stopFirstViewEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M start an AppLaunch ViewScope W handleEvent { app not displayed }`(
        ...
        // When
        testedScope.handleEvent(fakeAppStartEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
