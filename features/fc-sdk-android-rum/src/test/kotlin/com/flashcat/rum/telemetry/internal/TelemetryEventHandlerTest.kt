...
import com.flashcat.rum.telemetry.assertj.TelemetryConfigurationEventAssert.Companion.assertThat
import com.flashcat.rum.telemetry.assertj.TelemetryDebugEventAssert.Companion.assertThat
import com.flashcat.rum.telemetry.assertj.TelemetryErrorEventAssert.Companion.assertThat
import com.flashcat.rum.telemetry.assertj.TelemetryUsageEventAssert.Companion.assertThat
import com.flashcat.rum.telemetry.internal.TelemetryEventHandler.Companion.OKHTTP_INTERCEPTOR_HEADER_TYPES
import com.flashcat.rum.telemetry.internal.TelemetryEventHandler.Companion.OKHTTP_INTERCEPTOR_SAMPLE_RATE
...
internal class TelemetryEventHandlerTest {
    ...
    private fun assertApiUsageMatchesInternalEvent(
        ...
        assertThat(actual)
            ...
            .hasVersion(fakeFlashcatContext.sdkVersion)
    ...
    private fun assertConfigEventMatchesInternalEvent(
        ...
        val traceContext = fakeFlashcatContext.featuresContext[Feature.TRACING_FEATURE_NAME].orEmpty()
        assertThat(actual)
            .hasDate(time + fakeServerOffset)
            ...
            .hasIsMainProcess(fakeFlashcatContext.processInfo.isMainProcess)
            .hasTraceSampleRate(
