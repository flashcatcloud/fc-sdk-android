...
import com.flashcat.rum.rum.assertj.ResourceEventAssert.Companion.assertThat
...
import com.flashcat.rum.rum.internal.toResource
...
import com.flashcat.rum.rum.utils.asTimingsPayload
...
internal class RumResourceScopeTest {
            ...
            assertThat(firstValue)
                .apply {
                    ...
                    hasDeviceInfo(
                        ...
                        fakeFlashcatContext.deviceInfo.deviceType.toResourceSchemaType(),
    ...
    fun `M send Resource with timing W handleEvent(AddResourceTiming+StopResource)`(
        ...
        val resultTiming = testedScope.handleEvent(mockEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        Thread.sleep(RESOURCE_DURATION_MS)
        mockEvent = RumRawEvent.StopResource(fakeKey, statusCode, size, kind, attributes)
        val result = testedScope.handleEvent(mockEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M do nothing W handleEvent(WaitForResourceTiming+StopResource)`(
        ...
        val resultWaitForTiming =
            testedScope.handleEvent(mockEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        Thread.sleep(RESOURCE_DURATION_MS)
        mockEvent = RumRawEvent.StopResource(fakeKey, statusCode, size, kind, attributes)
        val resultStop = testedScope.handleEvent(mockEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M use explicit timings W handleEvent { AddResourceTiming + StopResource }`(
        ...
        testedScope
            ...
            ?.handleEvent(mockEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M update the duration to 1ns W handleEvent { computed duration less than 0 }`(
        ...
        // Given
        val result = testedScope.handleEvent(fakeStopEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
