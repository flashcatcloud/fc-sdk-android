...
package com.flashcat.rum.rum.internal.net
...
internal class RumRequestFactoryTest {
    ...
    fun `M create a proper request W create()`(
        ...
        // When
        val request = testedFactory.create(fakeFlashcatContext, fakeExecutionContext, batchData, batchMetadata)

        // Then
        requireNotNull(request)
        val expectedUrl = expectedUrl(fakeFlashcatContext.site.intakeEndpoint + "/api/v2/rum")
    ...
    private fun expectedUrl(endpointUrl: String): String {
        ...
        return buildString {
            append("$endpointUrl?ddsource=${fakeFlashcatContext.source}")
