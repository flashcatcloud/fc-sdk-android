...
import com.flashcat.rum.rum.internal.startup.testRumStartupScenarios
...
internal class RumSessionScopeTest {
    ...
    fun `M delegate events to child scope W handleViewEvent() {TRACKED}`(
        ...
        // When
        val result = testedScope.handleEvent(event, fakeFlashcatContext, mockEventWriteScope, mockWriter)

        // Then
        assertThat(result).isSameAs(testedScope)
        verify(mockChildScope).handleEvent(event, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    }
    ...
    fun `M delegate events to child scope W handleViewEvent() {NOT TRACKED}`() {
        ...
        // When
        val result = testedScope.handleEvent(mockEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)

        // Then
        assertThat(result).isSameAs(testedScope)
        verify(mockChildScope).handleEvent(
            same(mockEvent),
            same(fakeFlashcatContext),
    ...
    fun `M return null from handleEvent W stopped { completed child scopes }`() {
        ...
        // When
        val firstResult = testedScope.handleEvent(stopEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val secondResult = testedScope.handleEvent(fakeEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M keep session context W handleEvent(non interactive) {before expiration}`(
        ...
        // When
        val result = testedScope.handleEvent(mock(), fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val context = testedScope.getRumContext()
    ...
    fun `M keep session context W handleEvent(action) {before expiration}`(
        ...
        // When
        val result =
            testedScope.handleEvent(forge.startActionEvent(), fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val context = testedScope.getRumContext()
    ...
    fun `M update context W handleEvent(resource) {after expiration, background enabled}`(
        ...
        Thread.sleep(TEST_INACTIVITY_MS)
        val result =
            testedScope.handleEvent(forge.startResourceEvent(), fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val context = testedScope.getRumContext()
    ...
    fun `M update context W handleEvent(error) {after expiration, background enabled}`(
        ...
        // When
        Thread.sleep(TEST_INACTIVITY_MS)
        val result = testedScope.handleEvent(forge.addErrorEvent(), fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val context = testedScope.getRumContext()
    ...
    fun `M update context W handleEvent(non interactive) {after timeout threshold}`(
        ...
        repeat(repeatCount.toInt()) {
            ...
            testedScope.handleEvent(forge.startActionEvent(false), fakeFlashcatContext, mockEventWriteScope, mockWriter)
        }
    ...
    fun `M create new context W handleEvent(ResetSession)+getRumContext()`(
        ...
        // When
        val result =
            testedScope.handleEvent(RumRawEvent.ResetSession(), fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val context = testedScope.getRumContext()
    ...
    fun `M notify listener W session is updated {tracked, timed out}`(
        ...
        val result = testedScope.handleEvent(newEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val context = testedScope.getRumContext()
    ...
    fun `M notify listener W session is updated {tracked, manual reset}`(
        ...
        val result = testedScope.handleEvent(resetEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        testedScope.handleEvent(forge.startViewEvent(), fakeFlashcatContext, mockEventWriteScope, mockWriter)
        val context = testedScope.getRumContext()
    ...
    fun `M notify Session Replay feature W new interaction event received`(
        ...
        testedScope.handleEvent(fakeInteractionEvent1, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        testedScope.handleEvent(fakeInteractionEvent2, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M notify Session Replay feature W new non-interaction event received`(
        ...
        testedScope.handleEvent(fakeNonInteractionEvent1, fakeFlashcatContext, mockEventWriteScope, mockWriter)
        testedScope.handleEvent(fakeNonInteractionEvent2, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M notify Session Replay feature W session is updated {tracked, timed out}`(
        ...
        Thread.sleep(TEST_MAX_DURATION_MS)
        val newEvent = forge.startViewEvent()
        testedScope.handleEvent(newEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M notify Session Replay feature W session is updated {tracked, manual reset}`(
        ...
        // When
        val resetEvent = RumRawEvent.ResetSession()
        testedScope.handleEvent(resetEvent, fakeFlashcatContext, mockEventWriteScope, mockWriter)
    ...
    fun `M call reportTTID W handleEvent { AppLaunchTTIDEvent }`(
        ...
        testedScope.handleEvent(
            ...
            flashcatContext = fakeFlashcatContext,
