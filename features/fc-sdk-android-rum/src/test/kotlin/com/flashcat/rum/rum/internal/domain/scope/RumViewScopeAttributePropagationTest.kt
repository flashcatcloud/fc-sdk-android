...
internal class RumViewScopeAttributePropagationTest {
    ...
    fun `set up`(forge: Forge) {
        ...
        whenever(mockRumFeatureScope.withWriteContext(any(), any())) doAnswer {
            val callback = it.getArgument<(FlashcatContext, EventWriteScope) -> Unit>(1)
    ...
    fun `M send event with parent attributes W handleEvent(KeepAlive) on active view`() {
        ...
        // When
        val result =
            testedScope.handleEvent(RumRawEvent.KeepAlive(), fakeFlashcatContext, mockEventWriteScope, mockWriter)
