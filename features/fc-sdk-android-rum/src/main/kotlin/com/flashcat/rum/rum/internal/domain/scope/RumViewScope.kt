...
internal open class RumViewScope(
    ...
    override fun handleEvent(
        ...
        when (event) {
            is RumRawEvent.ResourceSent -> onResourceSent(event, flashcatContext, writeScope, writer)
            is RumRawEvent.ActionSent -> onActionSent(event, flashcatContext, writeScope, writer)
            is RumRawEvent.ErrorSent -> onErrorSent(event, flashcatContext, writeScope, writer)
            is RumRawEvent.LongTaskSent -> onLongTaskSent(event, flashcatContext, writeScope, writer)
            ...
            is RumRawEvent.StartView -> onStartView(event, flashcatContext, writeScope, writer)
            is RumRawEvent.StopView -> onStopView(event, flashcatContext, writeScope, writer)
            is RumRawEvent.StartAction -> onStartAction(event, flashcatContext, writeScope, writer)
            is RumRawEvent.StartResource -> onStartResource(event, flashcatContext, writeScope, writer)
            is RumRawEvent.AddError -> onAddError(event, flashcatContext, writeScope, writer)
            is RumRawEvent.AddLongTask -> onAddLongTask(event, flashcatContext, writeScope, writer)
            ...
            is RumRawEvent.ApplicationStarted -> onApplicationStarted(event, flashcatContext, writeScope, writer)
            is RumRawEvent.AddCustomTiming -> onAddCustomTiming(event, flashcatContext, writeScope, writer)
            is RumRawEvent.KeepAlive -> onKeepAlive(event, flashcatContext, writeScope, writer)

            is RumRawEvent.StopSession -> onStopSession(event, flashcatContext, writeScope, writer)
            ...
            is RumRawEvent.AddViewLoadingTime -> onAddViewLoadingTime(event, flashcatContext, writeScope, writer)
            ...
            is RumRawEvent.StartFeatureOperation -> onStartFeatureOperation(event, flashcatContext, writeScope, writer)
            is RumRawEvent.StopFeatureOperation -> onStopFeatureOperation(event, flashcatContext, writeScope, writer)

            else -> delegateEventToChildren(event, flashcatContext, writeScope, writer)
        }
    ...
    private fun onStartFeatureOperation(
        ...
        sendViewUpdate(event, flashcatContext, writeScope, writer)
    }
    ...
    private fun newVitalEvent(
        ...
        return RumVitalOperationStepEvent(
            ...
            device = RumVitalOperationStepEvent.Device(
                type = flashcatContext.deviceInfo.deviceType.toVitalSchemaType(),
            ...
            connectivity = flashcatContext.networkInfo.toVitalConnectivity(),
    ...
    private fun onAddViewLoadingTime(
        ...
        if (canUpdateViewLoadingTime) {
            updateViewLoadingTime(event, flashcatContext, writeScope, writer)
        }
    }
    ...
    private fun onStartView(
        ...
        stopScope(event, flashcatContext, writeScope, writer)
    }
    ...
    private fun onStopView(
        ...
        delegateEventToChildren(event, flashcatContext, writeScope, writer)
    ...
    private fun onStartAction(
        ...
        if (activeActionScope != null) {
            if (event.type == RumActionType.CUSTOM && !event.waitForStop) {
                ...
                pendingActionCount++
                customActionScope.handleEvent(RumRawEvent.SendCustomActionNow(), flashcatContext, writeScope, writer)
                return
            } else {
    ...
    private fun onAddError(
        ...
        sdkCore.newRumEventWriteOperation(flashcatContext, writeScope, writer, eventType) {
            val user = flashcatContext.userInfo
            val syntheticsAttribute = if (
                rumContext.syntheticsTestId.isNullOrBlank() ||
                rumContext.syntheticsResultId.isNullOrBlank()
            ...
            ErrorEvent(
                ...
                connectivity = flashcatContext.networkInfo.toErrorConnectivity(),
                ...
                device = ErrorEvent.Device(
                    type = flashcatContext.deviceInfo.deviceType.toErrorSchemaType(),
                    name = flashcatContext.deviceInfo.deviceName,
                    model = flashcatContext.deviceInfo.deviceModel,
                    brand = flashcatContext.deviceInfo.deviceBrand,
                    architecture = flashcatContext.deviceInfo.architecture,
        ...
        if (isFatal) {
            errorCount++
            crashCount++
            sendViewUpdate(event, flashcatContext, writeScope, writer, eventType)
        } else {
            pendingErrorCount++
        }
    }
    ...
    private fun delegateEventToChildren(
        ...
        delegateEventToResources(event, flashcatContext, writeScope, writer)
        delegateEventToAction(event, flashcatContext, writeScope, writer)
    }
    ...
    private fun delegateEventToAction(
        ...
        if (currentAction != null) {
            val updatedAction = currentAction.handleEvent(event, flashcatContext, writeScope, writer)
    ...
    private fun delegateEventToResources(
        ...
        while (iterator.hasNext()) {
            ...
            val scope = entry.value.handleEvent(event, flashcatContext, writeScope, writer)
            if (scope == null) {
     ...
     * @param flashcatContext the datadog context
        ...
        sdkCore.newRumEventWriteOperation(flashcatContext, writeScope, writer, eventType) {
            ...
            ViewEvent(
                ...
                device = ViewEvent.Device(
                    type = flashcatContext.deviceInfo.deviceType.toViewSchemaType(),
                    name = flashcatContext.deviceInfo.deviceName,
                    model = flashcatContext.deviceInfo.deviceModel,
                    brand = flashcatContext.deviceInfo.deviceBrand,
                    architecture = flashcatContext.deviceInfo.architecture,
                ...
                connectivity = flashcatContext.networkInfo.toViewConnectivity(),
                service = flashcatContext.service,
                version = flashcatContext.version,
                ddtags = buildDDTagsString(flashcatContext)
            ).apply {
    ...
    private fun onApplicationStarted(
        ...
        sdkCore.newRumEventWriteOperation(flashcatContext, writeScope, writer) {
            ...
            ActionEvent(
                ...
                connectivity = flashcatContext.networkInfo.toActionConnectivity(),
                service = flashcatContext.service,
                version = flashcatContext.version,
                ddtags = buildDDTagsString(flashcatContext)
            )
    ...
    private fun onAddLongTask(
        ...
        sdkCore.newRumEventWriteOperation(flashcatContext, writeScope, writer) {
            ...
            LongTaskEvent(
                ...
                connectivity = flashcatContext.networkInfo.toLongTaskConnectivity(),
                ...
                device = LongTaskEvent.Device(
                    type = flashcatContext.deviceInfo.deviceType.toLongTaskSchemaType(),
                    name = flashcatContext.deviceInfo.deviceName,
                    model = flashcatContext.deviceInfo.deviceModel,
                    brand = flashcatContext.deviceInfo.deviceBrand,
                    architecture = flashcatContext.deviceInfo.architecture
    ...
    private fun logSynthetics(key: String, value: String) {
         ...
         */
        Log.i("FlashcatSynthetics", "$key=$value")
    }
