...
import com.flashcat.rum.core.feature.event.JvmCrash
...
import com.flashcat.rum.rum.configuration.VitalsUpdateFrequency
import com.flashcat.rum.rum.internal.anr.ANRDetectorRunnable
import com.flashcat.rum.rum.internal.debug.UiRumDebugListener
import com.flashcat.rum.rum.internal.domain.InfoProvider
import com.flashcat.rum.rum.internal.domain.RumDataWriter
import com.flashcat.rum.rum.internal.domain.accessibility.AccessibilityInfo
import com.flashcat.rum.rum.internal.domain.accessibility.AccessibilitySnapshotManager
import com.flashcat.rum.rum.internal.domain.accessibility.DefaultAccessibilityReader
import com.flashcat.rum.rum.internal.domain.accessibility.DefaultAccessibilitySnapshotManager
import com.flashcat.rum.rum.internal.domain.accessibility.NoOpAccessibilityReader
import com.flashcat.rum.rum.internal.domain.accessibility.NoOpAccessibilitySnapshotManager
import com.flashcat.rum.rum.internal.domain.battery.BatteryInfo
import com.flashcat.rum.rum.internal.domain.battery.DefaultBatteryInfoProvider
import com.flashcat.rum.rum.internal.domain.battery.NoOpBatteryInfoProvider
import com.flashcat.rum.rum.internal.domain.display.DefaultDisplayInfoProvider
import com.flashcat.rum.rum.internal.domain.display.DisplayInfo
import com.flashcat.rum.rum.internal.domain.display.NoOpDisplayInfoProvider
import com.flashcat.rum.rum.internal.domain.event.RumEventMapper
import com.flashcat.rum.rum.internal.domain.event.RumEventMetaDeserializer
import com.flashcat.rum.rum.internal.domain.event.RumEventMetaSerializer
import com.flashcat.rum.rum.internal.domain.event.RumEventSerializer
import com.flashcat.rum.rum.internal.domain.event.RumViewEventFilter
import com.flashcat.rum.rum.internal.instrumentation.MainLooperLongTaskStrategy
import com.flashcat.rum.rum.internal.instrumentation.UserActionTrackingStrategyApi29
import com.flashcat.rum.rum.internal.instrumentation.UserActionTrackingStrategyLegacy
import com.flashcat.rum.rum.internal.instrumentation.gestures.DatadogGesturesTracker
import com.flashcat.rum.rum.internal.metric.slowframes.DefaultSlowFramesListener
import com.flashcat.rum.rum.internal.metric.slowframes.DefaultUISlownessMetricDispatcher
...
import com.flashcat.rum.rum.internal.monitor.DatadogRumMonitor
import com.flashcat.rum.rum.internal.net.RumRequestFactory
import com.flashcat.rum.rum.internal.startup.RumAppStartupDetector
import com.flashcat.rum.rum.internal.startup.RumFirstDrawTimeReporter
import com.flashcat.rum.rum.internal.startup.RumStartupScenario
import com.flashcat.rum.rum.internal.startup.RumTTIDInfo
import com.flashcat.rum.rum.internal.thread.NoOpScheduledExecutorService
import com.flashcat.rum.rum.internal.tracking.JetpackViewAttributesProvider
import com.flashcat.rum.rum.internal.tracking.NoOpInteractionPredicate
import com.flashcat.rum.rum.internal.tracking.NoOpUserActionTrackingStrategy
import com.flashcat.rum.rum.internal.tracking.UserActionTrackingStrategy
import com.flashcat.rum.rum.internal.vitals.AggregatingVitalMonitor
import com.flashcat.rum.rum.internal.vitals.CPUVitalReader
import com.flashcat.rum.rum.internal.vitals.FPSVitalListener
import com.flashcat.rum.rum.internal.vitals.FrameStateListener
import com.flashcat.rum.rum.internal.vitals.FrameStatesAggregator
import com.flashcat.rum.rum.internal.vitals.MemoryVitalReader
import com.flashcat.rum.rum.internal.vitals.NoOpVitalMonitor
import com.flashcat.rum.rum.internal.vitals.VitalMonitor
import com.flashcat.rum.rum.internal.vitals.VitalObserver
import com.flashcat.rum.rum.internal.vitals.VitalReader
import com.flashcat.rum.rum.internal.vitals.VitalReaderRunnable
import com.flashcat.rum.rum.metric.interactiontonextview.LastInteractionIdentifier
import com.flashcat.rum.rum.metric.interactiontonextview.NoOpLastInteractionIdentifier
...
import com.flashcat.rum.rum.metric.networksettled.NoOpInitialResourceIdentifier
...
import com.flashcat.rum.rum.tracking.NoOpTrackingStrategy
import com.flashcat.rum.rum.tracking.NoOpViewTrackingStrategy
import com.flashcat.rum.rum.tracking.TrackingStrategy
import com.flashcat.rum.rum.tracking.ViewAttributesProvider
import com.flashcat.rum.rum.tracking.ViewTrackingStrategy
...
/**
 * RUM feature class, which needs to be registered with Flashcat SDK instance.
 */
