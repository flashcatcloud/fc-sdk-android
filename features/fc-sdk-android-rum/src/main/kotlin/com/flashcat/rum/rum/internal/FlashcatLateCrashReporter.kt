...
import com.flashcat.rum.rum.internal.domain.event.RumEventDeserializer
import com.flashcat.rum.rum.internal.domain.scope.toErrorSchemaType
import com.flashcat.rum.rum.internal.domain.scope.tryFromSource
...
internal class DatadogLateCrashReporter(
    ...
    override fun handleNdkCrashEvent(
        ...
        rumFeature.withWriteContext { flashcatContext, writeScope ->
    ...
    override fun handleAnrCrash(
        ...
        if (anrExitInfo.timestamp > lastKnownViewStartedAt) {
            ...
            rumFeature.withWriteContext(
                ...
                if (lastViewEvent.session.id == flashcatContext.rumSessionId) return@withWriteContext
    ...
    private fun resolveErrorEventFromViewEvent(
        ...
        return ErrorEvent(
            ...
            date = timestamp + flashcatContext.time.serverTimeOffsetMs,
    ...
    private val FlashcatContext.rumSessionId: String?
