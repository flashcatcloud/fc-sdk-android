...
android {
    ...
    namespace = "com.flashcat.android.rum"
...
dependencies {
    api(project(":fc-sdk-android-core"))
    ...
    testImplementation(project(":features:fc-sdk-android-trace"))
    testImplementation(testFixtures(project(":fc-sdk-android-core")))
    testImplementation(testFixtures(project(":fc-sdk-android-internal")))
    testImplementation(testFixtures(project(":features:fc-sdk-android-trace")))
    unmock(libs.robolectric)

    // Test Fixtures
    testFixturesImplementation(testFixtures(project(":fc-sdk-android-core")))
    testFixturesImplementation(testFixtures(project(":fc-sdk-android-internal")))
