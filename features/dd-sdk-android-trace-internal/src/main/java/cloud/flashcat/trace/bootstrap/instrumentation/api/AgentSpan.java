...
import cloud.flashcat.trace.api.gateway.IGSpanInfo;
import cloud.flashcat.trace.api.gateway.RequestContext;
import cloud.flashcat.trace.api.interceptor.MutableSpan;
...
public interface AgentSpan extends MutableSpan, IGSpanInfo {
  ...
  interface Context {
     ...
     * Gets the SpanId.
     *
     * @return The span identifier, or {@link cloud.flashcat.trace.api.DDSpanId#ZERO} if not set.
     */
    long getSpanId();
