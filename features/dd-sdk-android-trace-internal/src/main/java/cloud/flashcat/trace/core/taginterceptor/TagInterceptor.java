package cloud.flashcat.trace.core.taginterceptor;

import static cloud.flashcat.trace.api.DDTags.ANALYTICS_SAMPLE_RATE;
import static cloud.flashcat.trace.api.DDTags.MEASURED;
import static cloud.flashcat.trace.api.DDTags.ORIGIN_KEY;
import static cloud.flashcat.trace.api.DDTags.SPAN_TYPE;
import static cloud.flashcat.trace.api.sampling.PrioritySampling.USER_DROP;
import static cloud.flashcat.trace.bootstrap.instrumentation.api.Tags.HTTP_METHOD;
import static cloud.flashcat.trace.bootstrap.instrumentation.api.Tags.HTTP_STATUS;
import static cloud.flashcat.trace.bootstrap.instrumentation.api.Tags.HTTP_URL;
import static cloud.flashcat.trace.core.taginterceptor.RuleFlags.Feature.FORCE_MANUAL_DROP;
import static cloud.flashcat.trace.core.taginterceptor.RuleFlags.Feature.PEER_SERVICE;
import static cloud.flashcat.trace.core.taginterceptor.RuleFlags.Feature.RESOURCE_NAME;
import static cloud.flashcat.trace.core.taginterceptor.RuleFlags.Feature.SERVICE_NAME;
import static cloud.flashcat.trace.core.taginterceptor.RuleFlags.Feature.STATUS_404;
import static cloud.flashcat.trace.core.taginterceptor.RuleFlags.Feature.STATUS_404_DECORATOR;
import static cloud.flashcat.trace.core.taginterceptor.RuleFlags.Feature.URL_AS_RESOURCE_NAME;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import cloud.flashcat.trace.api.Config;
import cloud.flashcat.trace.api.ConfigDefaults;
import cloud.flashcat.trace.api.DDTags;
import cloud.flashcat.trace.api.Pair;
import cloud.flashcat.trace.api.config.GeneralConfig;
import cloud.flashcat.trace.api.env.CapturedEnvironment;
import cloud.flashcat.trace.api.normalize.HttpResourceNames;
import cloud.flashcat.trace.api.sampling.SamplingMechanism;
import cloud.flashcat.trace.bootstrap.instrumentation.api.ErrorPriorities;
import cloud.flashcat.trace.bootstrap.instrumentation.api.InstrumentationTags;
import cloud.flashcat.trace.bootstrap.instrumentation.api.ResourceNamePriorities;
import cloud.flashcat.trace.bootstrap.instrumentation.api.Tags;
import cloud.flashcat.trace.bootstrap.instrumentation.api.URIUtils;
