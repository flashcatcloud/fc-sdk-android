...
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_AGENT_HOST;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_AGENT_TIMEOUT;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_AGENT_WRITER_TYPE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_CLIENT_IP_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_CLOCK_SYNC_PERIOD;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_DATA_STREAMS_BUCKET_DURATION;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_DATA_STREAMS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_DB_CLIENT_HOST_SPLIT_BY_HOST;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_DB_CLIENT_HOST_SPLIT_BY_INSTANCE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_DB_CLIENT_HOST_SPLIT_BY_INSTANCE_TYPE_SUFFIX;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_DB_DBM_PROPAGATION_MODE_MODE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_DOGSTATSD_START_DELAY;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_ELASTICSEARCH_BODY_AND_PARAMS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_ELASTICSEARCH_BODY_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_ELASTICSEARCH_PARAMS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_GRPC_CLIENT_ERROR_STATUSES;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_GRPC_SERVER_ERROR_STATUSES;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_HEALTH_METRICS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_HTTP_CLIENT_ERROR_STATUSES;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_HTTP_CLIENT_SPLIT_BY_DOMAIN;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_HTTP_CLIENT_TAG_QUERY_STRING;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_HTTP_SERVER_ERROR_STATUSES;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_HTTP_SERVER_ROUTE_BASED_NAMING;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_HTTP_SERVER_TAG_QUERY_STRING;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_JAX_RS_EXCEPTION_AS_ERROR_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_LOGS_INJECTION_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_PARTIAL_FLUSH_MIN_SPANS;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_PERF_METRICS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_PRIORITY_SAMPLING_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_PRIORITY_SAMPLING_FORCE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_PROPAGATION_EXTRACT_LOG_HEADER_NAMES_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_REMOTE_CONFIG_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_REMOTE_CONFIG_INTEGRITY_CHECK_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_REMOTE_CONFIG_MAX_PAYLOAD_SIZE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_REMOTE_CONFIG_POLL_INTERVAL_SECONDS;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_REMOTE_CONFIG_TARGETS_KEY;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_REMOTE_CONFIG_TARGETS_KEY_ID;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SCOPE_DEPTH_LIMIT;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SCOPE_ITERATION_KEEP_ALIVE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SECURE_RANDOM;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SERVICE_NAME;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SERVLET_ROOT_CONTEXT_SERVICE_NAME;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SITE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SPARK_TASK_HISTOGRAM_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_STARTUP_LOGS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TELEMETRY_DEBUG_REQUESTS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TELEMETRY_DEPENDENCY_COLLECTION_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TELEMETRY_EXTENDED_HEARTBEAT_INTERVAL;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TELEMETRY_HEARTBEAT_INTERVAL;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TELEMETRY_LOG_COLLECTION_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TELEMETRY_METRICS_INTERVAL;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_128_BIT_TRACEID_GENERATION_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_AGENT_PORT;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_AGENT_V05_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_ANALYTICS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_FLUSH_INTERVAL;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_HTTP_RESOURCE_REMOVE_TRAILING_SLASH;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_LONG_RUNNING_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_LONG_RUNNING_FLUSH_INTERVAL;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_PROPAGATION_EXTRACT_FIRST;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_PROPAGATION_STYLE;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_RATE_LIMIT;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_REPORT_HOSTNAME;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_RESOLVER_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_X_DATADOG_TAGS_MAX_LENGTH;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_WRITER_BAGGAGE_INJECT;
import static cloud.flashcat.trace.api.DDTags.INTERNAL_HOST_NAME;
import static cloud.flashcat.trace.api.DDTags.LANGUAGE_TAG_KEY;
import static cloud.flashcat.trace.api.DDTags.LANGUAGE_TAG_VALUE;
import static cloud.flashcat.trace.api.DDTags.PID_TAG;
import static cloud.flashcat.trace.api.DDTags.PROFILING_ENABLED;
import static cloud.flashcat.trace.api.DDTags.RUNTIME_ID_TAG;
import static cloud.flashcat.trace.api.DDTags.SCHEMA_VERSION_TAG_KEY;
import static cloud.flashcat.trace.api.DDTags.SERVICE;
import static cloud.flashcat.trace.api.config.CrashTrackingConfig.CRASH_TRACKING_AGENTLESS;
import static cloud.flashcat.trace.api.config.CrashTrackingConfig.CRASH_TRACKING_AGENTLESS_DEFAULT;
import static cloud.flashcat.trace.api.config.CrashTrackingConfig.CRASH_TRACKING_TAGS;
import static cloud.flashcat.trace.api.config.GeneralConfig.AZURE_APP_SERVICES;
import static cloud.flashcat.trace.api.config.GeneralConfig.DATA_STREAMS_BUCKET_DURATION_SECONDS;
import static cloud.flashcat.trace.api.config.GeneralConfig.DATA_STREAMS_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.DOGSTATSD_ARGS;
import static cloud.flashcat.trace.api.config.GeneralConfig.DOGSTATSD_NAMED_PIPE;
import static cloud.flashcat.trace.api.config.GeneralConfig.DOGSTATSD_PATH;
import static cloud.flashcat.trace.api.config.GeneralConfig.DOGSTATSD_START_DELAY;
import static cloud.flashcat.trace.api.config.GeneralConfig.ENV;
import static cloud.flashcat.trace.api.config.GeneralConfig.GLOBAL_TAGS;
import static cloud.flashcat.trace.api.config.GeneralConfig.HEALTH_METRICS_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.HEALTH_METRICS_STATSD_HOST;
import static cloud.flashcat.trace.api.config.GeneralConfig.HEALTH_METRICS_STATSD_PORT;
import static cloud.flashcat.trace.api.config.GeneralConfig.PERF_METRICS_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.PRIMARY_TAG;
import static cloud.flashcat.trace.api.config.GeneralConfig.RUNTIME_ID_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.RUNTIME_METRICS_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.SERVICE_NAME;
import static cloud.flashcat.trace.api.config.GeneralConfig.SITE;
import static cloud.flashcat.trace.api.config.GeneralConfig.STARTUP_LOGS_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.STATSD_CLIENT_QUEUE_SIZE;
import static cloud.flashcat.trace.api.config.GeneralConfig.STATSD_CLIENT_SOCKET_BUFFER;
import static cloud.flashcat.trace.api.config.GeneralConfig.STATSD_CLIENT_SOCKET_TIMEOUT;
import static cloud.flashcat.trace.api.config.GeneralConfig.TAGS;
import static cloud.flashcat.trace.api.config.GeneralConfig.TELEMETRY_DEPENDENCY_COLLECTION_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.TELEMETRY_EXTENDED_HEARTBEAT_INTERVAL;
import static cloud.flashcat.trace.api.config.GeneralConfig.TELEMETRY_HEARTBEAT_INTERVAL;
import static cloud.flashcat.trace.api.config.GeneralConfig.TELEMETRY_LOG_COLLECTION_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.TELEMETRY_METRICS_INTERVAL;
import static cloud.flashcat.trace.api.config.GeneralConfig.TRACER_METRICS_BUFFERING_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.TRACER_METRICS_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.TRACER_METRICS_MAX_AGGREGATES;
import static cloud.flashcat.trace.api.config.GeneralConfig.TRACER_METRICS_MAX_PENDING;
import static cloud.flashcat.trace.api.config.GeneralConfig.TRACE_DEBUG;
import static cloud.flashcat.trace.api.config.GeneralConfig.TRACE_TRIAGE;
import static cloud.flashcat.trace.api.config.GeneralConfig.VERSION;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_AGENTLESS;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_AGENTLESS_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_DATADOG_PROFILER_ENABLED;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_DIRECT_ALLOCATION_SAMPLE_LIMIT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_DIRECT_ALLOCATION_SAMPLE_LIMIT_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_HISTOGRAM_MAX_COLLECTION_SIZE;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_HISTOGRAM_MAX_COLLECTION_SIZE_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_HISTOGRAM_TOP_ITEMS;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_HISTOGRAM_TOP_ITEMS_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_RECORD_MESSAGE;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_RECORD_MESSAGE_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_SAMPLE_LIMIT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCEPTION_SAMPLE_LIMIT_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_EXCLUDE_AGENT_THREADS;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_PROXY_HOST;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_PROXY_PASSWORD;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_PROXY_PORT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_PROXY_PORT_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_PROXY_USERNAME;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_START_DELAY;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_START_DELAY_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_START_FORCE_FIRST;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_START_FORCE_FIRST_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_TAGS;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_TEMPLATE_OVERRIDE_FILE;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_COMPRESSION;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_COMPRESSION_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_PERIOD;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_PERIOD_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_SUMMARY_ON_413;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_SUMMARY_ON_413_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_TIMEOUT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_UPLOAD_TIMEOUT_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_URL;
import static cloud.flashcat.trace.api.config.RemoteConfigConfig.REMOTE_CONFIG_ENABLED;
import static cloud.flashcat.trace.api.config.RemoteConfigConfig.REMOTE_CONFIG_INTEGRITY_CHECK_ENABLED;
import static cloud.flashcat.trace.api.config.RemoteConfigConfig.REMOTE_CONFIG_MAX_PAYLOAD_SIZE;
import static cloud.flashcat.trace.api.config.RemoteConfigConfig.REMOTE_CONFIG_POLL_INTERVAL_SECONDS;
import static cloud.flashcat.trace.api.config.RemoteConfigConfig.REMOTE_CONFIG_TARGETS_KEY;
import static cloud.flashcat.trace.api.config.RemoteConfigConfig.REMOTE_CONFIG_TARGETS_KEY_ID;
import static cloud.flashcat.trace.api.config.RemoteConfigConfig.REMOTE_CONFIG_URL;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.DB_CLIENT_HOST_SPLIT_BY_HOST;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.DB_CLIENT_HOST_SPLIT_BY_INSTANCE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.DB_CLIENT_HOST_SPLIT_BY_INSTANCE_TYPE_SUFFIX;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.DB_DBM_PROPAGATION_MODE_MODE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.ELASTICSEARCH_BODY_AND_PARAMS_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.ELASTICSEARCH_BODY_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.ELASTICSEARCH_PARAMS_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.GOOGLE_PUBSUB_IGNORED_GRPC_METHODS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.GRPC_CLIENT_ERROR_STATUSES;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.GRPC_IGNORED_INBOUND_METHODS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.GRPC_IGNORED_OUTBOUND_METHODS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.GRPC_SERVER_ERROR_STATUSES;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.GRPC_SERVER_TRIM_PACKAGE_RESOURCE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_CLIENT_HOST_SPLIT_BY_DOMAIN;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_CLIENT_TAG_HEADERS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_CLIENT_TAG_QUERY_STRING;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_SERVER_DECODED_RESOURCE_PRESERVE_SPACES;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_SERVER_RAW_QUERY_STRING;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_SERVER_RAW_RESOURCE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_SERVER_ROUTE_BASED_NAMING;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_SERVER_TAG_QUERY_STRING;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HYSTRIX_MEASURED_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HYSTRIX_TAGS_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.IGNITE_CACHE_INCLUDE_KEYS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.INTEGRATION_SYNAPSE_LEGACY_OPERATION_NAME;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.JAX_RS_EXCEPTION_AS_ERROR_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.JMS_PROPAGATION_DISABLED_QUEUES;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.JMS_PROPAGATION_DISABLED_TOPICS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.JMS_UNACKNOWLEDGED_MAX_AGE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.KAFKA_CLIENT_BASE64_DECODING_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.KAFKA_CLIENT_PROPAGATION_DISABLED_TOPICS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.LOGS_INJECTION_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.MESSAGE_BROKER_SPLIT_BY_DESTINATION;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.OBFUSCATION_QUERY_STRING_REGEXP;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.PLAY_REPORT_HTTP_STATUS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RABBIT_INCLUDE_ROUTINGKEY_IN_RESOURCE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RABBIT_PROPAGATION_DISABLED_EXCHANGES;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RABBIT_PROPAGATION_DISABLED_QUEUES;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.SERVLET_ASYNC_TIMEOUT_ERROR;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.SERVLET_PRINCIPAL_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.SERVLET_ROOT_CONTEXT_SERVICE_NAME;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.SPARK_TASK_HISTOGRAM_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.SPRING_DATA_REPOSITORY_INTERFACE_RESOURCE_NAME;
import static cloud.flashcat.trace.api.config.TracerConfig.AGENT_HOST;
import static cloud.flashcat.trace.api.config.TracerConfig.AGENT_NAMED_PIPE;
import static cloud.flashcat.trace.api.config.TracerConfig.AGENT_PORT_LEGACY;
import static cloud.flashcat.trace.api.config.TracerConfig.AGENT_TIMEOUT;
import static cloud.flashcat.trace.api.config.TracerConfig.BAGGAGE_MAPPING;
import static cloud.flashcat.trace.api.config.TracerConfig.CLIENT_IP_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.CLOCK_SYNC_PERIOD;
import static cloud.flashcat.trace.api.config.TracerConfig.ENABLE_TRACE_AGENT_V05;
import static cloud.flashcat.trace.api.config.TracerConfig.HEADER_TAGS;
import static cloud.flashcat.trace.api.config.TracerConfig.HTTP_CLIENT_ERROR_STATUSES;
import static cloud.flashcat.trace.api.config.TracerConfig.HTTP_SERVER_ERROR_STATUSES;
import static cloud.flashcat.trace.api.config.TracerConfig.ID_GENERATION_STRATEGY;
import static cloud.flashcat.trace.api.config.TracerConfig.PARTIAL_FLUSH_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.PARTIAL_FLUSH_MIN_SPANS;
import static cloud.flashcat.trace.api.config.TracerConfig.PRIORITY_SAMPLING;
import static cloud.flashcat.trace.api.config.TracerConfig.PRIORITY_SAMPLING_FORCE;
import static cloud.flashcat.trace.api.config.TracerConfig.PROPAGATION_EXTRACT_LOG_HEADER_NAMES_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.PROXY_NO_PROXY;
import static cloud.flashcat.trace.api.config.TracerConfig.REQUEST_HEADER_TAGS;
import static cloud.flashcat.trace.api.config.TracerConfig.REQUEST_HEADER_TAGS_COMMA_ALLOWED;
import static cloud.flashcat.trace.api.config.TracerConfig.RESPONSE_HEADER_TAGS;
import static cloud.flashcat.trace.api.config.TracerConfig.SCOPE_DEPTH_LIMIT;
import static cloud.flashcat.trace.api.config.TracerConfig.SCOPE_INHERIT_ASYNC_PROPAGATION;
import static cloud.flashcat.trace.api.config.TracerConfig.SCOPE_ITERATION_KEEP_ALIVE;
import static cloud.flashcat.trace.api.config.TracerConfig.SCOPE_STRICT_MODE;
import static cloud.flashcat.trace.api.config.TracerConfig.SECURE_RANDOM;
import static cloud.flashcat.trace.api.config.TracerConfig.SERVICE_MAPPING;
import static cloud.flashcat.trace.api.config.TracerConfig.SPAN_SAMPLING_RULES;
import static cloud.flashcat.trace.api.config.TracerConfig.SPAN_SAMPLING_RULES_FILE;
import static cloud.flashcat.trace.api.config.TracerConfig.SPAN_TAGS;
import static cloud.flashcat.trace.api.config.TracerConfig.SPLIT_BY_TAGS;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_128_BIT_TRACEID_GENERATION_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_AGENT_ARGS;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_AGENT_PATH;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_AGENT_PORT;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_AGENT_URL;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_ANALYTICS_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_CLIENT_IP_HEADER;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_CLIENT_IP_RESOLVER_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_GIT_METADATA_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_HTTP_CLIENT_PATH_RESOURCE_NAME_MAPPING;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_HTTP_RESOURCE_REMOVE_TRAILING_SLASH;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_HTTP_SERVER_PATH_RESOURCE_NAME_MAPPING;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_PEER_SERVICE_COMPONENT_OVERRIDES;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_PEER_SERVICE_DEFAULTS_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_PEER_SERVICE_MAPPING;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_PROPAGATION_EXTRACT_FIRST;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_PROPAGATION_STYLE;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_PROPAGATION_STYLE_EXTRACT;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_PROPAGATION_STYLE_INJECT;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_RATE_LIMIT;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_REMOVE_INTEGRATION_SERVICE_NAMES_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_REPORT_HOSTNAME;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_RESOLVER_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_SAMPLE_RATE;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_SAMPLING_OPERATION_RULES;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_SAMPLING_RULES;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_SAMPLING_SERVICE_RULES;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_SPAN_ATTRIBUTE_SCHEMA;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_STRICT_WRITES_ENABLED;
import static cloud.flashcat.trace.api.config.TracerConfig.TRACE_X_DATADOG_TAGS_MAX_LENGTH;
import static cloud.flashcat.trace.api.config.TracerConfig.WRITER_BAGGAGE_INJECT;
import static cloud.flashcat.trace.api.config.TracerConfig.WRITER_TYPE;
import static cloud.flashcat.trace.util.CollectionUtils.tryMakeImmutableSet;

import androidx.annotation.NonNull;

import cloud.flashcat.android.trace.internal.compat.function.Function;
import cloud.flashcat.trace.api.config.GeneralConfig;
import cloud.flashcat.trace.api.config.ProfilingConfig;
import cloud.flashcat.trace.api.config.TracerConfig;
...
import cloud.flashcat.trace.logger.LoggerFactory;
import cloud.flashcat.trace.util.PidHelper;
