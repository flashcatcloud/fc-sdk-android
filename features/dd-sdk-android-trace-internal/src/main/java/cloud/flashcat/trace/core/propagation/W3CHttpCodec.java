...
import static cloud.flashcat.trace.api.TracePropagationStyle.TRACECONTEXT;
import static cloud.flashcat.trace.api.sampling.PrioritySampling.SAMPLER_DROP;
import static cloud.flashcat.trace.api.sampling.PrioritySampling.SAMPLER_KEEP;
import static cloud.flashcat.trace.core.propagation.HttpCodec.firstHeaderValue;
import static cloud.flashcat.trace.core.propagation.PropagationTags.HeaderType.W3C;
import static java.util.concurrent.TimeUnit.MILLISECONDS;
import static java.util.concurrent.TimeUnit.NANOSECONDS;

import cloud.flashcat.android.trace.internal.compat.function.Supplier;
import cloud.flashcat.trace.api.Config;
import cloud.flashcat.trace.api.DD128bTraceId;
...
import cloud.flashcat.trace.api.internal.util.LongStringUtils;
