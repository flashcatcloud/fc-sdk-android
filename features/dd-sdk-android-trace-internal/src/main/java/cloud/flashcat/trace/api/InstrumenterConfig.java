...
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_INTEGRATIONS_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_MEASURE_METHODS;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_RESOLVER_RESET_INTERVAL;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_RUNTIME_CONTEXT_FIELD_INJECTION;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_SERIALVERSIONUID_FIELD_INJECTION;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TELEMETRY_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_128_BIT_TRACEID_LOGGING_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_ANNOTATIONS;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_ANNOTATION_ASYNC;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_EXECUTORS_ALL;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_METHODS;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_TRACE_OTEL_ENABLED;
import static cloud.flashcat.trace.api.ConfigDefaults.DEFAULT_USM_ENABLED;
import static cloud.flashcat.trace.api.config.GeneralConfig.INTERNAL_EXIT_ON_FAILURE;
import static cloud.flashcat.trace.api.config.GeneralConfig.TELEMETRY_ENABLED;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_DIRECT_ALLOCATION_ENABLED;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_DIRECT_ALLOCATION_ENABLED_DEFAULT;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_ENABLED;
import static cloud.flashcat.trace.api.config.ProfilingConfig.PROFILING_ENABLED_DEFAULT;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.HTTP_URL_CONNECTION_CLASS_NAME;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.INTEGRATIONS_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.JDBC_CONNECTION_CLASS_NAME;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.JDBC_PREPARED_STATEMENT_CLASS_NAME;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.LEGACY_INSTALLER_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.MEASURE_METHODS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RESOLVER_CACHE_CONFIG;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RESOLVER_CACHE_DIR;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RESOLVER_NAMES_ARE_UNIQUE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RESOLVER_RESET_INTERVAL;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RESOLVER_USE_LOADCLASS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RESOLVER_USE_URL_CACHES;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.RUNTIME_CONTEXT_FIELD_INJECTION;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.SERIALVERSIONUID_FIELD_INJECTION;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_128_BIT_TRACEID_LOGGING_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_ANNOTATIONS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_ANNOTATION_ASYNC;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_CLASSES_EXCLUDE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_CLASSES_EXCLUDE_FILE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_CLASSLOADERS_EXCLUDE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_CODESOURCES_EXCLUDE;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_EXECUTORS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_EXECUTORS_ALL;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_METHODS;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_OTEL_ENABLED;
import static cloud.flashcat.trace.api.config.TraceInstrumentationConfig.TRACE_THREAD_POOL_EXECUTORS_EXCLUDE;
import static cloud.flashcat.trace.util.CollectionUtils.tryMakeImmutableList;
