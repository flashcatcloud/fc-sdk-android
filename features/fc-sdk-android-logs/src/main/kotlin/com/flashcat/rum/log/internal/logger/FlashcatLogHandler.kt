...
package com.flashcat.rum.log.internal.logger
...
import com.flashcat.rum.log.internal.domain.LogGenerator
    ...
    override fun handleLog(
        ...
        if (sampler.sample(Unit)) {
            if (logsFeature != null) {
                ...
                logsFeature.withWriteContext(withFeatureContexts) { flashcatContext, writeScope ->
                    val log = createLog(
                        level,
                        flashcatContext,
                        message,
