...
import com.flashcat.rum.log.internal.LogsFeature
import com.flashcat.rum.log.internal.domain.DatadogLogGenerator
import com.flashcat.rum.log.internal.logger.CombinedLogHandler
import com.flashcat.rum.log.internal.logger.DatadogLogHandler
import com.flashcat.rum.log.internal.logger.LogHandler
import com.flashcat.rum.log.internal.logger.LogcatLogHandler
import com.flashcat.rum.log.internal.logger.NoOpLogHandler
...
internal constructor(internal var handler: LogHandler) {
     ...
     * @see [documentation](https://docs.flashcat.cloud/tagging/#defining-tags)
     */
    ...
    internal companion object {
        ...
        internal const val SDK_NOT_INITIALIZED_WARNING_MESSAGE =
            "You're trying to create a Logger instance, but the SDK was not yet initialized. " +
                ...
                "Please initialize the Flashcat SDK first before" +
