...
package com.flashcat.rum.trace.opentelemetry
...
import com.flashcat.rum.trace.internal.DatadogTracingToolkit.setTraceId128BitGenerationEnabled
import com.flashcat.rum.trace.opentelemetry.internal.FlashcatContextStorageWrapper
import com.flashcat.rum.trace.opentelemetry.internal.executeIfJavaFunctionPackageExists
...
// endregion
    ...
    internal companion object {
        init {
            // We need to add the FlashcatContextStorageWrapper and this should be executed before
            ...
            executeIfJavaFunctionPackageExists(
                ...
                @Suppress("NewApi")
                ContextStorage.addWrapper(FlashcatContextStorageWrapper())
            }
        }
