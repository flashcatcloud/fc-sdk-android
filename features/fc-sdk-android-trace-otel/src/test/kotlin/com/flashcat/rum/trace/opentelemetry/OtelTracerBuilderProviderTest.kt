...
import com.flashcat.rum.trace.api.forceSamplingDecision
import com.flashcat.rum.trace.api.partialFlushMinSpans
import com.flashcat.rum.trace.api.resourceName
import com.flashcat.rum.trace.api.serviceName
...
internal class OtelTracerBuilderProviderTest {
    ...
    fun `M build a Span with lazy Datadog context W startSpan()`(
        @Forgery fakeInitialFlashcatContext: FlashcatContext
    ) {
        // Given
        val tracer = testedOtelTracerProviderBuilder
            .build()
        ...
        val mockContextFuture = completedFutureMock(fakeInitialFlashcatContext)
