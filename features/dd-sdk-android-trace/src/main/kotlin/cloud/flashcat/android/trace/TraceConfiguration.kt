...
import cloud.flashcat.android.trace.event.NoOpSpanEventMapper
...
data class TraceConfiguration internal constructor(
    ...
    class Builder {
        ...
        /**
         * Sets the [SpanEventMapper] for the Trace [cloud.flashcat.android.trace.model.SpanEvent].
         * You can use this interface implementation to modify the
         * [cloud.flashcat.android.trace.model.SpanEvent] attributes before serialisation.
         *
