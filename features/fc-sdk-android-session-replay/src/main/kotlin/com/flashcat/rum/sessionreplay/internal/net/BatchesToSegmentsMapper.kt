...
import com.flashcat.rum.sessionreplay.internal.gson.safeGetAsJsonArray
import com.flashcat.rum.sessionreplay.internal.gson.safeGetAsJsonObject
import com.flashcat.rum.sessionreplay.internal.gson.safeGetAsLong
import com.flashcat.rum.sessionreplay.internal.processor.EnrichedRecord
import com.flashcat.rum.sessionreplay.internal.processor.tryFromSource
import com.flashcat.rum.sessionreplay.internal.utils.SessionReplayRumContext
...
internal class BatchesToSegmentsMapper(private val internalLogger: InternalLogger) {
    ...
    fun map(flashcatContext: FlashcatContext, batchData: List<ByteArray>): List<Pair<MobileSegment, JsonObject>> {
        return groupBatchDataIntoSegments(flashcatContext, batchData)
    }
    ...
    private fun groupBatchDataIntoSegments(
        ...
        return batchData
            ...
            .mapNotNull {
                mapToSegment(flashcatContext, it.key, it.value)
            }
    }
    ...
    private fun mapToSegment(
        ...
        val segment = MobileSegment(
            ...
            source = MobileSegment.Source.tryFromSource(flashcatContext.source, internalLogger),
            records = emptyList()
        )
