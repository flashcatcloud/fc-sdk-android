...
import com.flashcat.rum.api.net.RequestFactory.Companion.HEADER_API_KEY
import com.flashcat.rum.api.net.RequestFactory.Companion.HEADER_EVP_ORIGIN
import com.flashcat.rum.api.net.RequestFactory.Companion.HEADER_EVP_ORIGIN_VERSION
import com.flashcat.rum.api.storage.RawBatchEvent
import com.flashcat.rum.sessionreplay.forge.ForgeConfigurator
import com.flashcat.rum.sessionreplay.internal.net.ResourcesRequestFactory.Companion.APPLICATION_ID
import com.flashcat.rum.sessionreplay.internal.net.ResourcesRequestFactory.Companion.UPLOAD_DESCRIPTION
...
internal class ResourcesRequestFactoryTest {
    ...
    fun `set up`(forge: Forge) {
        ...
        whenever(mockFlashcatSite.intakeEndpoint).thenReturn(FlashcatSite.US1.toString())
        whenever(fakeFlashcatContext.site).thenReturn(mockFlashcatSite)
        val fakeFeaturesContext = mapOf(Feature.RUM_FEATURE_NAME to fakeRumFeature)
        whenever(fakeFlashcatContext.featuresContext).thenReturn(fakeFeaturesContext)
