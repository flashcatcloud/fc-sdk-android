...
internal class BatchesToSegmentsMapperTest {
    ...
    @Forgery
    lateinit var flashcatContext: FlashcatContext
    ...
    fun `M group the records into segments by context W map`(forge: Forge) {
        ...
        // When
        val mappedSegments = testedMapper.map(flashcatContext, fakeBatchData)
    ...
    fun `M return empty list W map{ empty records }`(
        ...
        // When
        assertThat(testedMapper.map(flashcatContext, fakeBatchData)).isEmpty()
    }
