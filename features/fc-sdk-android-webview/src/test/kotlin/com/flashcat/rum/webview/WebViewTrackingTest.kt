...
internal class WebViewTrackingTest {
    ...
    fun `M pass web view event to RumWebEventConsumer W consumeWebViewEvent()`(
        ...
        val mockFlashcatContext = mock<FlashcatContext>()
        whenever(mockFlashcatContext.featuresContext) doReturn fakeFeaturesContext
