...
internal class DatadogTracerAdapterTest {
    ...
    @Mock
    private lateinit var mockContextFuture: Future<FlashcatContext?>

    @BeforeEach
    fun `set up`(forge: Forge) {
        fakeRumContext = forge.aRumContext()
        mockRumFeatureScope = SdkFeatureMock.create(mockContextFuture)
        whenever(mockContextFuture.get()) doReturn forge.aFlashcatContextWithRumContext(fakeRumContext)
