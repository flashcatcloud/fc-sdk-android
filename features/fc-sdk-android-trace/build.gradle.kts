...
android {
    ...
    namespace = "com.flashcat.android.trace"
...
dependencies {
    ...
    api(project(":features:fc-sdk-android-trace-api"))
    implementation(project(":fc-sdk-android-internal"))
    implementation(project(":features:fc-sdk-android-trace-internal"))
    ...
    testFixturesImplementation(project(":features:fc-sdk-android-trace-internal"))
}
