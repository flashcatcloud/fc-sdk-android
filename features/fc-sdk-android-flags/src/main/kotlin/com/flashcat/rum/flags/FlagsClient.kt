...
import com.flashcat.rum.flags.internal.DatadogFlagsClient
import com.flashcat.rum.flags.internal.DefaultRumEvaluationLogger
import com.flashcat.rum.flags.internal.FlagsFeature
import com.flashcat.rum.flags.internal.LogWithPolicy
import com.flashcat.rum.flags.internal.NoOpFlagsClient
import com.flashcat.rum.flags.internal.NoOpRumEvaluationLogger
import com.flashcat.rum.flags.internal.RumEvaluationLogger
import com.flashcat.rum.flags.internal.evaluation.EvaluationsManager
import com.flashcat.rum.flags.internal.model.FlagsContext
import com.flashcat.rum.flags.internal.net.PrecomputedAssignmentsDownloader
import com.flashcat.rum.flags.internal.repository.DefaultFlagsRepository
import com.flashcat.rum.flags.internal.repository.NoOpFlagsRepository
import com.flashcat.rum.flags.internal.repository.net.PrecomputeMapper
import com.flashcat.rum.flags.model.EvaluationContext
import com.flashcat.rum.flags.model.ResolutionDetails
...
interface FlagsClient {
    ...
    companion object {
         ...
         * @param sdkCore the SDK instance. Defaults to the default Flashcat instance.
        ...
        internal fun createInternal(
            ...
            val flashcatContext = (featureSdkCore as InternalSdkCore).getFlashcatContext()

            // Validate required context
            if (flashcatContext == null) {
                flagsFeature.logErrorWithPolicy(
                    message = "Missing FlashcatContext from SDK core",
                    level = InternalLogger.Level.ERROR,
                    shouldCrashInStrict = true
                )
                ...
                return NoOpFlagsClient(
                    name = name,
                    reason = "Failed to create client - missing FlashcatContext",
                    logWithPolicy = { message, level ->
                        flagsFeature.logErrorWithPolicy(message, level, shouldCrashInStrict = false)
                    }
                )
