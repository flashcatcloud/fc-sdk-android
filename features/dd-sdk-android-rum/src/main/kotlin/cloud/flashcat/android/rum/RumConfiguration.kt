...
import cloud.flashcat.android.rum.event.ViewEventMapper
...
data class RumConfiguration internal constructor(
    ...
    class Builder(private val applicationId: String) {
         ...
         * @see [cloud.flashcat.android.rum.tracking.ActivityViewTrackingStrategy]
         * @see [cloud.flashcat.android.rum.tracking.FragmentViewTrackingStrategy]
         * @see [cloud.flashcat.android.rum.tracking.MixedViewTrackingStrategy]
         * @see [cloud.flashcat.android.rum.tracking.NavigationViewTrackingStrategy]
         */
