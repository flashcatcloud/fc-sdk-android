...
import cloud.flashcat.android.rum.internal.metric.SessionEndedMetric
...
internal class RumViewManagerScope(
    ...
    companion object {
        ...
        internal const val RUM_BACKGROUND_VIEW_ID = "cloud.flashcat.background.view"
        internal const val RUM_BACKGROUND_VIEW_URL = "cloud/flashcat/background/view"
        internal const val RUM_BACKGROUND_VIEW_NAME = "Background"

        internal const val RUM_APP_LAUNCH_VIEW_ID = "cloud.flashcat.application-launch.view"
        internal const val RUM_APP_LAUNCH_VIEW_URL = "cloud/flashcat/application-launch/view"
