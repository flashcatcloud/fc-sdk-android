...
include(":features:dd-sdk-android-logs-noop")
include(":features:dd-sdk-android-profiling-noop")
include(":features:dd-sdk-android-flags-noop")
include(":features:dd-sdk-android-flags-openfeature-noop")
include(":features:dd-sdk-android-session-replay-noop")
include(":features:dd-sdk-android-session-replay-compose-noop")
include(":features:dd-sdk-android-session-replay-material-noop")
...
// SAMPLE PROJECTS (Excluded - depend on removed features)
